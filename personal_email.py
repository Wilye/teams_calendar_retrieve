import requests
from personal_config import group_id
...
<p>If you haven't already, please remember to log your PTO and travel time in the PTO-Travel channel on Microsoft Teams in the JERA Americas_IT Teams at least one week ahead. By the end of today Friday, you should make sure that you have logged your PTO and travel time that you will begin to take from {next_start_date} - {next_end_date} on the <a href="https://teams.microsoft.com/l/channel/19%3a487f4479c76746ceaae6b24b89c7a2c4%40thread.tacv2/PTO-%2520Travel?groupId=9717b8b0-c079-4946-a99b-3cae873d321e&tenantId=2840389b-0f81-496f-b742-ac794a5da61e">PTO-Travel channel calendar</a>.</p>
